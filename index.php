  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg bg-light fixed-top py-3">
      <div class="container">
        ...
        <div
          class="collapse navbar-collapse nav-button"
    ...
    <section id="brand" class="container">
      <div class="row">
        <img
          src="assets/imgs/versace.png"
          alt=""
          class="img-fluid col-lg-3 col-md-6 col-sm-13"
        />

        <img
          src="assets/imgs/pepsi.png"
          alt=""
          class="img-fluid col-lg-3 col-md-6 col-sm-13"
        />

        <img
          src="assets/imgs/michealkor.png"
          alt=""
          class="img-fluid col-lg-3 col-md-6 col-sm-13"
        />
        <img
          src="assets/imgs/nestle.png"
          alt=""
          class="img-fluid col-lg-3 col-md-6 col-sm-13"
        />
      </div>
    ...
    <section id="featured " class="my-5 pb-5">
      ...
      <div class="row mx-auto container-fluid">
        ...
        <div class="product text-center col-lg-3 col-md-4 col-sm-12">
          <img
            src="assets/imgs/versacecap.jpeg"
            alt=""
        ...
        <div class="product text-center col-lg-3 col-md-4 col-sm-12">
          <img
            src="assets/imgs/versacepant.jpeg"
            alt=""
            class="img-fluid mb-3"
          />
          <div class="star">
    ...
    <section id="clothes " class="my-5">
      ...
      <div class="row mx-auto container-fluid">
        <div class="product text-center col-lg-3 col-md-4 col-sm-12">
          <img src="assets/imgs/c1.jpeg" alt="" class="img-fluid mb-3" />
          <div class="star">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
